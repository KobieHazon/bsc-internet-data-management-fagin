...
required_files = ['assignment/HW3_2018.pdf', 'question2a.py', 'question2b.txt', 'fagin_files/data1.csv', 'fagin_files/data2.csv', 'fagin_files/data3.csv']
...
required_markers = ['csv', 'max_func', 'is_seen', 'sorted']
